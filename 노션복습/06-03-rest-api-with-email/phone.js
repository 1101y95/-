...
export async function sendTokenToSMS(phone,token){
    const appKeyPhone = process.env.appKeyPhone
    const XSecretKeyPhone = process.env.XSecretKeyPhone
    const sender = process.env.senderPhone

   await axios.post(
       `https://api-sms.cloud.toast.com/sms/v3.0/appKeys/${appKeyPhone}/sender/sms`,
        {
